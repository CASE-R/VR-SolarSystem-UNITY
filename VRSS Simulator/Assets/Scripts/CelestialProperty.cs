...
public class CelestialProperty : MonoBehaviour
{
    ...
    [Tooltip("Angular Momentum of Object")]
    public float angularMomentum; // L = 2π m r^2 / p , m is mass r is radius
    ...
    private void InitialiseParameters()
    {
        ...
        //angularMomentum = Mass * Vector3.Dot(volumetricMeanRadius, orbitalVelocity);
    }
